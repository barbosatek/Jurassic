...
namespace UnitTests
{
    ...
    public class StatementTests
    {
        ...
        public void Function()
        {
            ...
            Assert.IsInstanceOf<Jurassic.Library.FunctionInstance>(TestUtils.Evaluate("var a; function a() { return 6 }; a"));
            Assert.IsInstanceOf<Jurassic.Library.FunctionInstance>(TestUtils.Evaluate("function a() { return 6 }; var a; a"));
